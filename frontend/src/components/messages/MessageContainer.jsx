	...
	return (
		<div className='md:min-w-[450px] flex flex-col'>
			{!selectedConversation ? (
				...
				<>
					{/* Header */}
					<div className='bg-[#A2B9E7] px-4 py-2 mb-2'>
						<span className='label-text text-slate-900'>To:</span>{" "}
	...
	return (
		<div className='flex items-center justify-center w-full h-full'>
			<div className='px-4 text-center sm:text-lg md:text-xl text-slate-700 font-semibold flex flex-col items-center gap-2'>
				...
				<TiMessages className='text-3xl md:text-6xl text-center text-slate-700' />
			</div>
		</div>
	);
};